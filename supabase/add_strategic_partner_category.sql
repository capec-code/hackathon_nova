-- Add 'strategic' category to sponsors table
-- This migration adds support for Strategic Community Partners category
...
-- Create or replace the constraint to include 'strategic'
ALTER TABLE sponsors 
DROP CONSTRAINT IF EXISTS sponsors_category_check;

ALTER TABLE sponsors 
ADD CONSTRAINT sponsors_category_check 
CHECK (category IN ('title', 'gold', 'silver', 'tech', 'internet', 'printing', 'strategic', 'community', 'media'));
